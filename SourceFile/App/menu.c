...
void InitializeMenu(void)
{
	...
	//loveywm 20140906
	App.Menu.LogoForm.form_num = LogoRorm;
	App.Menu.CheckForm.form_num = CheckForm;
	App.Menu.WorkForm.form_num = WorkForm;
	App.Menu.SetupForm.form_num = SetupForm;
	App.Menu.ServiceForm.form_num = ServiceForm;
